...
class ConvertToDF:
    ...
    def __init__(self, num_weeks_lookback,
                 ...
                 train_data_stats_path="genie-dt-cit-baselines-forecasting/0_data/variable_stats/variable_stats.csv",
                 ):


        self.num_weeks_lookback = num_weeks_lookback
        self.num_forecast_days = num_forecast_days
        self.train_data_stats_path = train_data_stats_path
        self.train_data_stats = None
        self.variable_means = None
    ...
    def convert_split_data_to_long_df(self, data):
        ...
        if self.train_data_stats is None:
            self.train_data_stats = pd.read_csv(self.train_data_stats_path)
            self.variable_means = self.train_data_stats[["event_name", "mean"]]
        ...
        for variable_to_predict in data["sampled_variables"]:
            ...
            for var in all_overlapping_lab_vars:
                if var in self.variable_means.event_name.values:
                    mean_value = self.variable_means.loc[
                        self.variable_means["event_name"] == var, "mean"
                    ].values[0]
...
all_overlapping_lab_vars = ['3173_2',
 '6301_6',
 '4544_3',
 '789_8',
 '6690_2',

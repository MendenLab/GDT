...
def main(path_to_save, num_samples_per_lot, split):
    ...
    wandb.run.name = f"Generating data with text -{split} -num_samples_per_lot - {num_samples_per_lot}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path_to_save", type=str, default="/0_data/3_samples_per_lot_text/", 
    ...
    main(args.path_to_save, args.num_samples_per_lot, args.split)

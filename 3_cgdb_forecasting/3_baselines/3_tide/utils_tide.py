...
def finetune_tide_model(train_ag_data, prediction_length, log_path, include_all_columns=False, time_limit=3600, num_trials=5, patience_nr_epochs=20):
            ...
            "TiDE": [  # Using TiDE model key
                {
                    ...
                    "early_stopping_patience": patience_nr_epochs,

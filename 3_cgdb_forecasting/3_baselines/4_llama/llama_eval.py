...
def main(indication, prediction_url, base_path_text_arg=base_path_text, eval_base_path_arg=eval_base_path):
    ...
    wandb.init(project="genie-dt-cgdb-baselines-forecasting", mode="offline" if DEBUG else "online", group="llama-3.1-8b")
...
if __name__ == "__main__":
    ...
    # Example usage: python llama_eval.py --indication_list enhanced_multiplemyeloma enhanced_rcc --prediction_url http://0.0.0.0:8067/v1/ 
    ...
    for indication in args.indication_list:
        main(indication, args.prediction_url, args.base_path_text, args.eval_base_path)
